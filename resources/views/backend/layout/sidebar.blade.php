    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="sidebar-layouts">
                <ul class="nav flex-column sub-menu">
                    <li style="border:1px solid black; height:40px">
                        <input type="text" style="height:80%" class="form-control bg-transparent border-0" placeholder="Tìm sản phẩm">
                    </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li style="border:1px solid black; height:40px">
                        <input type="text" style="height:80%" class="form-control bg-transparent border-0" placeholder="Tìm tác giả">
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('admin.authors.index')}}">Danh sách tác giả</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    <li style="border:1px solid black; height:40px">
                        <input type="text" style="height:80%" class="form-control bg-transparent border-0" placeholder="Tìm thể loại">
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('admin.categories.index')}}">Danh sách thể loại</a></li>
